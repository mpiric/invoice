	...
	<tabset class="tabbable" type="pills">
		<tab heading="Table Order">
			<div class="row" ng-controller="orderCtrl">
					...
					<fieldset>
						...
						<div class="table-responsive panel-scroll height-250" perfect-scrollbar wheel-propagation="false" suppress-scroll-x="true">
							<table class="table table-hover" id="table_list">
								...
								<tbody>
									<tr ng-repeat="row in data" id="table_row_{{row.table_number}}" style="cursor:pointer" ng-click="chnageTable({{row.table_detail_id}},{{row.table_number}},row)" > <!-- b4 row ,{{row.max_capacity}} -->
				...
				<div class="col-md-9" id="bill_div" ><!-- style="pointer-events:none;opacity:0.6" -->
					...
					<input type="hidden" id="branch_name" name="branch_name" ng-model="branch_name"> 
						...
						<fieldset>
							...
							<div class="row">
								...
								<ui-select ng-model="waiter_list.selected" theme="bootstrap" ng-required="true" on-select="update_order()"> <!-- ui-select-required -->
									<ui-select-match placeholder="Select Captain...">
										{{$select.selected.waiter_code}}
									</ui-select-match>
									<ui-select-choices repeat="item in waiter_list | propsFilter: {waiter_code: $select.search} "  ><!-- | filter: $select.search -->
						...
						<div class="row">	
							<div class="form-group col-md-6">						
								<ui-select ng-model="product_list.selected" id="product_list" theme="bootstrap" ng-required="true"  > <!-- ui-select-required -->
									<ui-select-match placeholder="Search by Product...">
										{{$select.selected.name}}
									</ui-select-match>
									<ui-select-choices repeat="item in product_list | propsFilter: {name: $select.search, product_code: $select.search}  "  ><!-- | filter: { name: $select.search }  -->
										<!-- <small ng-bind-html="item.product_code | highlight: $select.search"></small> --><div ng-bind-html="item.name | highlight: $select.search"></div>
						...
						<div class="table-responsive" id="product_table_div">
							...
							<table>
								<tr><td>Total Qty : </td><td align="right">{{totalDisplayQty().toFixed(2)}}</td></tr>
								
								<tr><td>Total Amount : </td><td align="right">{{totalAmount().toFixed(2)}}</td></tr>
								<tr id="total_tax_1_div"  ng-show="show_tax_1"><td>{{tax_1}}  : </td><td align="right">{{service_tax_total().toFixed(2)}}</td></tr>
								<tr id="total_tax_2_div"  ng-show="show_tax_2"><td>{{tax_2}} : </td><td align="right">{{other_tax_total().toFixed(2)}}</td></tr>
								
								<tr id="final_amount_div"><td>Sub Total : </td><td align="right">{{finalTotal().toFixed(2)}}</td></tr>
								...
								<tr><td>Payment Type:</td><td><select  class="form-control" name="payment_type" ng-model="payment_type" ng-options="item as item.value for item in payment_type_list track by item.key"  tabindex="-1" ng-change="updatePaymentType()" ng-disabled="!online">
					        	 		<option value="" ng-if ="false"></option>
					          	 	</select></td></tr>
					          	 <tr ng-show="payment_type.key==2"><td>Credit Card Number: </td><td><input style="width: 50%" type="text" class="form-control" ng-model="payment_card_number" id="payment_card_number" placeholder="Credit Card Number" name="payment_card_number" tabindex="-1" ng-keyup="changePayment_card_numberOnKeyup(payment_card_number)" ng-keydown="changePayment_card_numberOnKeydown(payment_card_number)" ng-disabled="!online" only-digits></td></tr>
					          	 <tr ng-show="payment_type.key==3"><td>Debit Card Number: </td><td><input style="width: 50%" type="text" class="form-control" ng-model="payment_card_number" ng-keyup="changePayment_card_numberOnKeyup(payment_card_number)" ng-keydown="changePayment_card_numberOnKeydown(payment_card_number)"  id="payment_card_number" placeholder="Debit Card Number" name="payment_card_number" tabindex="-1" ng-disabled="!online" only-digits></td></tr>
								...
								<tr> <td>TOTAL : </td> <td align="right" >{{finalOrderTotal().toFixed(2)}}</td>
								
								<tr style="font-size:18px;color:#5b5b60 ;padding:5px 0px;"> <td><b>GRAND TOTAL : </b></td> <td align="right" ><b>{{round_off_finalOrderTotal().toFixed(2)}}</b></td>
								
								<tr > <td>Given Amount : </td> <td  ><input style="width:100%;" id="given_amount_div" type="text" name="given_amount" ng-keyup="changeGivenAmountOnKeyup(given_amount)" ng-keydown="changeGivenAmountOnKeydown(given_amount)" ng-model="given_amount" tabindex="-1" ng-disabled="!online" only-digits></td>
								
								<tr> <td>Return Amount : </td> <td align="right" >{{(given_amount-round_off_finalOrderTotal()).toFixed(2)}}</td>
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<button  ng-disabled="countTotalProductsLive() || !online" class="btn btn-lg btn-primary btn-o hidden-print" ng-click="resetOrder()"><!-- ng-click="placeOrder()" -->
									Reset
		...
		<tab heading="Parcel Order">
			...
			<div class="row" ng-controller="parcelOrderCtrl">
				...
				<div class="col-md-12" id="parcel_bill_div" ><!-- style="pointer-events:none;opacity:0.6" -->
					...
					<form action="javascript:void(0)" name="parcel_order_form" novalidate method="post" >
						...
						<input type="hidden" id="branch_name" name="branch_name" ng-model="branch_name"> 
							...
							<fieldset>
								<legend>Bill details <!-- - <span id="parcel_bill_number"></span> --></legend>	
								...
								<div class="row">	
									...
									<div class="form-group col-md-4">						
									<ui-select ng-model="waiter_list.selected" theme="bootstrap" ng-required="true" on-select="update_order_parcel()"> <!-- ui-select-required -->
										<ui-select-match placeholder="Select Captain...">
											{{$select.selected.waiter_code}}
										</ui-select-match>
										<ui-select-choices repeat="item in waiter_list | propsFilter: {waiter_code: $select.search} "  ><!-- | filter: $select.search -->
									...
									<div class="form-group col-md-4">						
										<ui-select ng-model="parcel_product_list.selected" id="parcel_product_list" theme="bootstrap" ng-required="true"  > <!-- ui-select-required --> <!-- focus-name="p1" -->
											<ui-select-match placeholder="Search by Product...">
												{{$select.selected.name}}
											</ui-select-match>
							...
							<div class="table-responsive" id="product_table_div">
								...
								<div style="float:right" id="total_div">	
									...
									<table>
										<tr><td>Total Amount : </td><td>{{parcel_totalAmount()}}</td></tr>
										<tr id="parcel_total_tax_1_div"  ng-show="parcel_show_tax_1"><td>{{parcel_tax_1}}  : </td><td>{{parcel_service_tax_total()}}</td></tr>
										<tr id="parcel_total_tax_2_div"  ng-show="parcel_show_tax_2"><td>{{parcel_tax_2}} : </td><td>{{parcel_other_tax_total()}}</td></tr>
										<tr><td>-----------------------------------------</td></tr>
										<tr id="parcel_final_amount_div"><td>Sub Total : </td><td>{{parcel_finalTotal()}}</td></tr>
										<tr><td>-----------------------------------------</td></tr>
										<tr><td>Discount Type:</td><td><select style="width: 50%" ng-change="parcel_requestDiscounttype()" class="form-control" name="discount_type" ng-model="parcel_discount_type" ng-options="item as item.value for item in parcel_discount_type_list track by item.key"  tabindex="-1" ng-disabled="!online">
							        	 		<option value="" ng-if ="false"></option>
							          	 	</select></td></tr>
							          	 <tr ng-show="parcel_discount_type.key==2"><td>Discount Amount: </td><td><input style="width: 50%" type="text" class="form-control" ng-model="parcel_discount_amount" ng-change="parcel_requestDiscounttype()" id="parcel_discount_amount" placeholder="Discount" name="discount_amount" tabindex="-1" ng-disabled="!online" only-digits></td></tr>
							          	 <tr><td>-----------------------------------------</td></tr>

							          	 <tr><td>Payment Type:</td><td><select style="width: 50%" class="form-control" name="payment_type" ng-model="parcel_payment_type" ng-options="item as item.value for item in parcel_payment_type_list track by item.key"  tabindex="-1" ng-change="parcel_updatePaymentType()" ng-disabled="!online">
					        	 		<option value="" ng-if ="false"></option>
					          	 	</select></td></tr>
					          	 <tr ng-show="parcel_payment_type.key==2"><td>Credit Card Number: </td><td><input style="width: 50%" type="text" class="form-control" ng-model="parcel_payment_card_number" id="parcel_payment_card_number" placeholder="Credit Card Number" name="payment_card_number" tabindex="-1" ng-keyup="parcel_changePayment_card_numberOnKeyup(parcel_payment_card_number)" ng-keydown="parcel_changePayment_card_numberOnKeydown(parcel_payment_card_number)" ng-disabled="!online" only-digits></td></tr>
					          	 <tr ng-show="parcel_payment_type.key==3"><td>Debit Card Number: </td><td><input style="width: 50%" type="text" class="form-control" ng-model="parcel_payment_card_number" ng-keyup="changePayment_card_numberOnKeyup(parcel_payment_card_number)" ng-keydown="changePayment_card_numberOnKeydown(parcel_payment_card_number)"  id="parcel_payment_card_number" placeholder="Debit Card Number" name="payment_card_number" tabindex="-1" ng-disabled="!online" only-digits></td></tr>
					          	 <tr><td>-----------------------------------------</td></tr>
										...
										<tr>
											...
											<table>
												<tr ng-repeat="bs_tax1 in parcel_branchSpecificTax_list">
													<td>{{bs_tax1.tax_name}} ( {{bs_tax1.tax_percent}} % ) : {{calculateBranchSpecificTaxParcel(bs_tax1.tax_percent)}} </td>
												</tr>
											</table>
										</tr>
										<tr><td>-----------------------------------------</td></tr>
									...
									<p><b> TOTAL : {{parcel_finalOrderTotal()}}</b></p>
						      		<p><b> Round Off TOTAL : {{round_off_parcel_finalOrderTotal()}}</b></p>

									<p >Given Amount : <input id="parcel_given_amount_div" type="text" name="given_amount" ng-keyup="parcel_changeGivenAmountOnKeyup(parcel_given_amount)" ng-keydown="parcel_changeGivenAmountOnKeydown(parcel_given_amount)" ng-model="parcel_given_amount" tabindex="-1" ng-disabled="!online" only-digits></p>
									<p id="parcel_return_amount_div">Return Amount : {{(parcel_given_amount-parcel_finalOrderTotal()).toFixed(2)}}</p>

									<p style="font-size:22px; float:right">Daily Income : {{parcel_dailyIncome}}</p>
		...
		<tab heading="Delivery Order">
			...
			<div class="row" ng-controller="deliveryOrderCtrl">
				...
				<div class="col-md-12" id="delivery_bill_div" ><!-- style="pointer-events:none;opacity:0.6" -->
					...
					<form action="javascript:void(0)" name="delivery_order_form" novalidate method="post" >
						...
						<input type="hidden" id="branch_name" name="branch_name" ng-model="branch_name"> 
							...
							<fieldset>
								<legend>Bill details <!-- - <span id="delivery_bill_number"></span> --></legend>	

								<div class="row">
									<div class="form-group col-md-4">	
										<input type="text" name="customer_name" placeholder="Customer Name" ng-model="customer_name" class="form-control" focus-name="p1" required>	
										<div class="has-error" ng-show="delivery_order_form.$submitted || delivery_order_form.customer_name.$touched">
									...
									<div class="form-group col-md-4">
										<input type="text" name="customer_address" placeholder="Customer Address" ng-model="customer_address" class="form-control" required> 	
										<div class="has-error" ng-show="delivery_order_form.$submitted || delivery_order_form.customer_address.$touched">
								...
								<div class="row">	
									<div class="form-group col-md-4">						
										<ui-select ng-model="delivery_product_list.selected" theme="bootstrap" ng-required="true"  > <!-- ui-select-required --> <!-- focus-name="p1" -->
											<ui-select-match placeholder="Search by Product...">
												{{$select.selected.name}}
											</ui-select-match>
							...
							<div class="table-responsive" id="product_table_div">
								...
								<div style="float:right" id="total_div">	
									...
									<table>
										<tr><td>Total Amount : </td><td>{{delivery_totalAmount()}}</td></tr>
										<tr id="delivery_total_tax_1_div"  ng-show="delivery_show_tax_1"><td>{{delivery_tax_1}}  : </td><td>{{delivery_service_tax_total()}}</td></tr>
										<tr id="delivery_total_tax_2_div"  ng-show="delivery_show_tax_2"><td>{{delivery_tax_2}} : </td><td>{{delivery_other_tax_total()}}</td></tr>
										<tr><td>-----------------------------------------</td></tr>
										<tr id="delivery_final_amount_div"><td>Sub Total : </td><td>{{delivery_finalTotal()}}</td></tr>
										<tr><td>-----------------------------------------</td></tr>
										<tr><td>Discount Type:</td><td><select style="width: 50%" ng-change="delivery_requestDiscounttype()" class="form-control" name="discount_type" ng-model="delivery_discount_type" ng-options="item as item.value for item in delivery_discount_type_list track by item.key" ng-disabled="!online" tabindex="-1">
							        	 		<option value="" ng-if ="false"></option>
							          	 	</select></td></tr>
							          	 <tr ng-show="delivery_discount_type.key==2"><td>Discount Amount: </td><td><input style="width: 50%" type="text" class="form-control" ng-model="delivery_discount_amount" ng-change="delivery_requestDiscounttype()" id="delivery_discount_amount" placeholder="Discount" name="discount_amount" tabindex="-1" ng-disabled="!online" only-digits></td></tr>

							          	 <tr><td>-----------------------------------------</td></tr>
										<tr><td>Payment Type:</td><td><select style="width: 50%" class="form-control" name="payment_type" ng-model="delivery_payment_type" ng-options="item as item.value for item in delivery_payment_type_list track by item.key"  tabindex="-1" ng-disabled="!online" ng-change="delivery_updatePaymentType()">
					        	 		<option value="" ng-if ="false"></option>
					          	 	</select></td></tr>
					          	 <tr ng-show="delivery_payment_type.key==2"><td>Credit Card Number: </td><td><input style="width: 50%" type="text" class="form-control" ng-model="delivery_payment_card_number" id="delivery_payment_card_number" placeholder="Credit Card Number" name="payment_card_number" tabindex="-1" ng-keyup="delivery_changePayment_card_numberOnKeyup(delivery_payment_card_number)" ng-keydown="delivery_changePayment_card_numberOnKeydown(delivery_payment_card_number)" ng-disabled="!online"  only-digits></td></tr>
					          	 <tr ng-show="delivery_payment_type.key==3"><td>Debit Card Number: </td><td><input style="width: 50%" type="text" class="form-control" ng-model="delivery_payment_card_number" ng-keyup="changePayment_card_numberOnKeyup(delivery_payment_card_number)" ng-keydown="changePayment_card_numberOnKeydown(delivery_payment_card_number)"  id="delivery_payment_card_number" placeholder="Debit Card Number" name="payment_card_number" tabindex="-1" ng-disabled="!online" only-digits></td></tr>
					          	 <tr><td>-----------------------------------------</td></tr>


											<table>
												<tr ng-repeat="bs_tax in delivery_branchSpecificTax_list">
													<td>{{bs_tax.tax_name}} ( {{bs_tax.tax_percent}} % ) : {{calculateBranchSpecificTax(bs_tax.tax_percent)}} </td>											
												</tr>
											</table>
										</tr>
										<tr><td>-----------------------------------------</td></tr>
									...
									<p><b> TOTAL : {{delivery_finalOrderTotal()}}</b></p>
						      		<p><b> Round Off TOTAL : {{round_off_delivery_finalOrderTotal()}}</b></p>

									<p >Given Amount : <input id="delivery_given_amount_div" type="text" name="given_amount" ng-keyup="delivery_changeGivenAmountOnKeyup(delivery_given_amount)" ng-keydown="delivery_changeGivenAmountOnKeydown(delivery_given_amount)" ng-model="delivery_given_amount" tabindex="-1" ng-disabled="!online" only-digits></p>
									<p id="delivery_return_amount_div">Return Amount : {{(delivery_given_amount-delivery_finalOrderTotal()).toFixed(2)}}</p>

									<p style="font-size:22px; float:right">Daily Income : {{delivery_dailyIncome}}</p>
