...
<html lang="en" data-ng-app="clipApp">
	<head>
		...
		<title data-ng-bind="pageTitle()">Restaurant Management</title>
		<!-- Google fonts -->
		...
		<!-- Themify Icons -->
		<link rel="stylesheet" href="<?php echo base_url('bower_components/themify-icons/themify-icons.css'); ?>">
		<!-- Loading Bar -->
		<link rel="stylesheet" href="<?php echo base_url('bower_components/angular-loading-bar/build/loading-bar.min.css'); ?>">
		<!-- Animate Css -->
		...
		<!-- Clip-Two Theme -->
		<link rel="stylesheet" data-ng-href="<?php echo base_url('assets/css/themes/{{ app.layout.theme }}.css'); ?>" />
	</head>
	<body ng-controller="AppCtrl">
		...
		<script src="<?php echo base_url('assets/js/config.constant.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/config.router.js'); ?>"></script>
		<!-- Clip-Two Directives -->
		<script src="<?php echo base_url('assets/js/directives/toggle.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/perfect-scrollbar.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/empty-links.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/sidebars.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/off-click.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/full-height.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/panel-tools.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/char-limit.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/dismiss.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/compare-to.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/select.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/directives/messages.js'); ?>"></script>
		
		<script src="<?php echo base_url('assets/js/directives/sparkline.js'); ?>"></script>
		
		<script src="<?php echo base_url('assets/js/directives/file-upload.js'); ?>"></script>
		<!-- Clip-Two Controllers -->				
		<script src="<?php echo base_url('assets/js/controllers/mainCtrl.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/controllers/bootstrapCtrl.js'); ?>"></script>
		<!-- Google Apis -->
