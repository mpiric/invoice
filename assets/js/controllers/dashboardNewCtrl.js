 ...
 */
app.controller('dashboardNewCtrl', ["$scope", "$http", "$state", function($scope, $http, state) {
    ...
    request.success(function(response) {
        ...
        if (response.status == "1") {
            ...
            $scope.top_items = response.top_items;
            //console.log($scope.top_items);
        }
...
app.controller('VisitsCtrl', ["$scope", "$http", "$state", function($scope, $http, state) {
    var request = $http({

        method: "post",
        url: "index.php/branch/last_week_sale",
        data: {},
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
    ...
    request.success(function(response) {
        ...
        //console.log(response.data_day);
        //console.log(response.data_income);
        ...
        for (var i = 0; i < response.length; i++) {
            ...
            d_label.push(response[i].data_day);
            d_income.push(response[i].data_income);
        }
        //console.log(d_label);

        // $scope.data_day = response;
        //$scope.data_income = response.data_income;
...
app.controller('MonthlySalesCtrl', ["$scope", "$http", "$state", function($scope, $http, state) {
    var request = $http({

        method: "post",
        url: "index.php/branch/monthly_sales",
        data: {},
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
    ...
    request.success(function(response) {
        ...
        $scope.data = {
            ...
            datasets: [{
                label: 'Weekly data',
                fillColor: 'rgba(0, 149, 200, 0.2)',
                strokeColor: 'rgba(0, 149, 200, 1)',
                pointColor: 'rgba(0, 149, 200, 1)',
                pointStrokeColor: '#fff',
                pointHighlightFill: '#fff',
                pointHighlightStroke: 'rgba(0, 149, 200, 1)',
                data: d_income
            }]
        };
