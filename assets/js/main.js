...
function ($window,$rootScope, $state, $stateParams) {
    ...
    $rootScope.app = {
        name: 'Restaurant Management System', // name of your project
        author: 'MPIRIC SOFTWARES', // author's name or company name
        description: 'Restaurant Management System', // brief description
